...
```{r echo=FALSE, message=FALSE, warning=FALSE,fig.height=3,fig.width=4.5, fig.cap= "Number of routes for each line"}
...
```{r echo=FALSE, message=FALSE, warning=FALSE,fig.height=3,fig.width=4.5, fig.cap= "Top 10 lines with the most number of trips"}
...
```{r echo=FALSE, message=FALSE, warning=FALSE,fig.height=3,fig.width=4.5, fig.cap= "Routes Travel Time VS. Day Type"}
library(ggplot2)
